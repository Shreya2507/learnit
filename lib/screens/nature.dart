...
class NatureChallengePage extends StatefulWidget {
  const NatureChallengePage({Key? key}) : super(key: key);

  @override
  State<NatureChallengePage> createState() => _NatureChallengePageState();
}

class _NatureChallengePageState extends State<NatureChallengePage> {
            ...
            child: Column(
              children: [
                ...
                _buildDashboardCard(
                  ...
                  locked: false,
                  onTap: () {
                    Navigator.pushNamed(context, '/natureMatchGame');
                  },
                ),
                _buildDashboardCard(
                  title: 'Level 2',
                  ...
                  locked: false,
                  onTap: () {
                    Navigator.pushNamed(context, '/natureGames');
                  },
                ),
                _buildDashboardCard(
                  title: 'Level 3',
